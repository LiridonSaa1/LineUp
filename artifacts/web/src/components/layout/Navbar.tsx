...
export function Navbar() {
  ...
  return (
    <>
      {/* ── Main header ── */}
      <header className={`fixed top-0 left-0 right-0 z-40 transition-all duration-500 ${scrolled ? "py-1.5" : "py-0 border-b border-border/20 bg-background/90 backdrop-blur-xl"}`}>
